...
<!--[![Github All Releases](https://img.shields.io/github/downloads/pyginny/pyginny/total.svg)]()-->
...
Run `make test` to invoke the test suite, found in the tests subdirectory.
